...
cadir = '/volumes/client-certs' # directory of the client certificates
...
os.system("ip addr add 192.168.70.4/24 dev {}".format(ifname)) # set the route
os.system("ip link set dev {} up".format(ifname)) # set the interface up
os.system("ip route add 192.168.60.0/24 dev {} via 192.168.70.4".format(ifname)) # set the route
...
client_auth = IP()
client_auth.src = '192.168.70.4' # set the source IP address
